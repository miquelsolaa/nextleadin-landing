    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Tens dubtes? Som aquí.</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Tot sobre la generació de leads, IA, integracions i suport.<br />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              <h4 className="text-xl font-semibold text-gray-900 mb-2">Vols rebre novetats i actualitzacions?</h4>
            </div>
