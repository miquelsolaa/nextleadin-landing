...
**Preferred tools**: Use Read, Write, Edit, Bash, Glob, and Grep for codebase exploration, implementation, profiling harnesses, and analysis. Request additional tools from the parent agent when needed (e.g., specialized APM tooling, external load generators, or environment-specific observability access).
