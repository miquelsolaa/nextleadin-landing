...
**Preferred tools**: Use Read, Grep, Glob, WebFetch, and WebSearch for market research, competitive intelligence, and synthesizing authoritative sources. Request additional tools from the parent agent when needed.
