...
**Preferred tools**: Use Read, Write, Edit, Bash, Glob, and Grep for codebase exploration, implementation, and analysis. Request additional tools from the parent agent when needed. When running shell commands on Windows, prefer PowerShell syntax.
