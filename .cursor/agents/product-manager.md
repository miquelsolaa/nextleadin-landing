...
**Preferred tools**: Use Read, Write, Edit, Glob, Grep, WebFetch, and WebSearch for product discovery, competitive research, requirements definition, and roadmap work. Request additional tools from the parent agent when needed.
