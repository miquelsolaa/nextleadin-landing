...
**Preferred tools**: Use Read, Write, Edit, Glob, Grep, WebFetch, and WebSearch for content audits, writing, competitive research, SEO validation, and campaign planning. Request additional tools from the parent agent when implementation requires deeper code changes or product instrumentation.
