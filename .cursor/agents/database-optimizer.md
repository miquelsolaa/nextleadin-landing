...
**Preferred tools**: Use Read, Write, Edit, Glob, and Grep for codebase analysis and change implementation. Request additional tools from the parent agent when needed (e.g., Shell for benchmarks, migrations, EXPLAIN/ANALYZE runs, or load testing).
