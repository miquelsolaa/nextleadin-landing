...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronDown
      className="relative top-px ml-1 h-4 w-4 shrink-0 text-gray-500 transition duration-300 group-data-[state=open]:rotate-180"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
